<?php
//启动方式，正确安装php并下载好本文件后，运行 php -S 0.0.0.0:8000 ，用手机访问 http://电脑IP:8000/fileupload.php 在上传就可以了
//获取图片存储文件夹路径
$imgSavePathsStart = "./";
//var_dump($_FILES);
...
<div>
    ...
    <input id="uploadFiles" name="files" type="file" multiple="" accept=".jpg,.jpeg,.png,.bmp,.gif,.webp"/>
    <br/>
