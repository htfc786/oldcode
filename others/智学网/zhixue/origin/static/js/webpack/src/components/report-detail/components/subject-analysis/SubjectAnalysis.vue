<template src="./subjectAnalysis.html"></template>
<style src="./subjectAnalysis.less" lang="less"></style>
<script>
...
// WEBPACK FOOTER //
// src/components/report-detail/components/subject-analysis/SubjectAnalysis.vue